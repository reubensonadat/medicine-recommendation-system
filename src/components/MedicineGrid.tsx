...
import { Star, AlertTriangle, Search, Pill, Package, Clock, ArrowRight } from "lucide-react"
          ...
          >
            ...
            <CardContent className="pt-0">
              ...
              <Button 
                variant="outline" 
                size="sm" 
                className="w-full mt-3 text-xs h-9 sm:h-8 transition-all duration-200 hover:bg-gray-50"
                onClick={(e) => {
                  e.stopPropagation()
                  if (onMedicineClick) {
                    onMedicineClick(medicine)
